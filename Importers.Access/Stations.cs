...
internal static class Stations
{
    ...
    {
        var result = new Station(record.GetInt32(record.GetOrdinal("LayoutStationId")), record.GetString(record.GetOrdinal("FullName")), record.GetString(record.GetOrdinal("Signature")));
        layout.Add(result);
    }
}
