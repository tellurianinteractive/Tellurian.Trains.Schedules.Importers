...
public interface IImportService
{
    ...
    /// <returns>An <see cref="ImportResult{T}"/> containing the imported <see cref="Plan"/> and any validation messages.</returns>
    Task<ImportResult<Plan>> ImportScheduleAsync(string name);
}
