...
/// for a driver duty where two consecutive same-train parts are worked by different traction units (see
/// <see cref="Duties.DriverDutyExtensions.TractionExchangeNotes"/>). The note belongs at <paramref name="At"/>,
