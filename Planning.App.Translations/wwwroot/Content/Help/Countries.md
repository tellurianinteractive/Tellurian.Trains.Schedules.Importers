...
- a **name**, displayed in the current interface language;
- a **country code**, the ISO two-letter code (for example *SE* or *DE*);
- one or more **languages**, reflecting the languages spoken in that country.
...
- **Companies** belong to a country and are filtered by the countries in this catalogue.
...
- **Add country** lets you select a country from the catalogue that is not yet in your layout and
  add it. Foreign countries can be added for cargo routing and international trains.
- **Delete** removes a country from your layout. It is blocked while any company or region still
  references it — reassign or remove those first. The default country cannot be deleted.
